						...
						<table class="table no-margin">
							...
							<tbody>
								<tr>
									...
									<td><?php if($right_sign_docs){echo date('m-d-Y, h:i A',strtotime($right_sign_docs->created_date));}else{?><?php }?></td>
									
									
								</tr>
								<tr>
									<td>Basic Reporting Info</td>
								     <td id="basic_info_status"></td>
									<td id="basic_info_date"></td>
									
								</tr>
								<tr>
									<td>Benefit Plan Info</td>
									<td id="benefit_plan_status"></td>
									<td id="benefit_info_date"></td>
									
								</tr>
								<tr>
									<td>Payroll Data</td>
                                      <td id="payroll_status"></td>
									<td id="payroll_date"></td>
									
								</tr>
								<tr>
									<td>Medical Plan Data</td>
									<td id="medical_status"></td>
									<td id="medical_date"></td>
									
								</tr>
								<tr>
									<td>ACA Form Generation</td>
										<td  id="form_generation_status"></td>
									<td  id="form_generation_date"></td>
								...
								<tr>
									...
									<td  id="approved_status"></td>
									<td  id="approved_date"></td>
									
								</tr>
								<tr>
									<td>E-Filing</td>
									<td  id="efile_status"></td>
									<td  id="efile_date"></td>
...
<!--<div id="download-documents" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
	  ...
	  <div class="modal-body" id ="sharefile_folders_body" style="float:left;width:100%;">
	  
      </div>
      <div class="modal-footer" id ="sharefile_folders_footer">
...
$('#uploadfileform-document').bind('change', function() {
	  ...
	  if(((this.files[0].size/1024/1024).toFixed(2)) > 8){
		  toastr.error('Uploaded file size should not be more than 8MB');
	...
	$(document).ready(function () { 
			...
			dashboardstatuscheck('<?php echo $_GET["c_id"];?>');
			
			//setTimeout(sharefilefolders('<?php echo $_GET["c_id"];?>'), 2000)
			//sharefilefolders('<?php echo $_GET["c_id"];?>');
		});
</script> 