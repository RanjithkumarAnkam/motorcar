...
<?php // $this->registerCssFile(Yii::$app->getUrlManager()->getBaseUrl()."/css/client/planclass.css"); ?>
<link rel="stylesheet"
...
<div class="box box-warning container-fluid padding-responsive">
	<div class="box-header with-border ">
		<h3 class="box-title col-xs-6">
			Update <?php echo Html::encode($model_plan_coverage_type->plan_class_number); ?> - <?php echo Html::encode($company_details->company_name); ?> <small> (<?php echo Html::encode($company_details->company_client_number); ?>) </small>
		</h3>
			...
			<div class="">
						...
						<div class="box-group" id="accordion">
							...
							<div class="panel  box ">
								<div class="parent-tabs box-header with-border">
									...
									<span id="step_coverage" class="steps col-xs-2 "
										onclick="editbasic();"> <span class="check "> <i
									...
									<h4 class="box-title col-sm-6 col-xs-10">
										<div id="step_coverage_number_div"
											class="fixed-number col-sm-1 col-xs-2  " style="top: 3px;">
											<span class="block-number">9</span>
										</div>
										<a class="custom-bg col-sm-11 col-xs-10 white"
											data-parent="#accordion" style="padding-left: 0;"> Coverage
											Type and Waiting Period </a>
									</h4>
														...
														<div class="col-md-offset-1 col-md-10">
															<div class="col-xs-12">
																<div class="form-group ">
																	<div class="col-md-5">
																		<label class="control-label"><h4>9.1&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['9.1'])){ echo Html::encode($arrsection_elements['9.1']); } ?></h4>
																		</label>
																	</div>
																	<div class="col-md-7">
																		<input type="text" class="form-control form-height"
																			id="" placeholder=""
																			value="<?php echo $model_plan_coverage_type->plan_class_number; ?>"
																			readonly disabled>
																...
																<div class="form-group ">
																	<div class="col-md-5">
																		<label class="control-label"><h4>9.2&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['9.2'])){ echo Html::encode($arrsection_elements['9.2']); } ?></h4>
																		</label>
																	</div>
																	<div class="col-md-7">
																...
																<div class="form-group row plan-div-margin">
																	...
																	<div class="col-md-3">
																		<div class="row">
																			<input type="radio"
																				name="TblAcaPlanCoverageType[plantype]" value="1"
																				<?php
																		...
																		<div class="row">
																			<input type="radio"
																				name="TblAcaPlanCoverageType[plantype]" value="2"
																				<?php
																	...
																	<div class="col-md-4">
																		<div class="row">
																			<input type="radio"
																				name="TblAcaPlanCoverageType[plantype]" value="3"
																				<?php
																		...
																		<div class="row">
																			<input type="radio"
																				name="TblAcaPlanCoverageType[plantype]" value="4"
																				<?php
																	...
																	<div class="col-md-6">
																		<div class="row">
																			<input type="radio"
																				name="TblAcaPlanCoverageType[plantype]" value="5"
																				<?php
																	...
																	<div class="col-md-12" style="border: 1px solid #ddd;">
																		<div class="form-group plan-div-margin">
																			...
																			<div class="col-md-6">
																				<div class="">
																					<input type="radio"
																						name="TblAcaPlanCoverageType[doh]"
																						...
																						if (isset ( $model_plan_coverage_type->plan_type_doh ) && $model_plan_coverage_type->plan_type_doh == 1) {
																							...
																							?>
																						checked <?php  } ?> value="1"><span
																						class="control-checkbox">&nbsp;&nbsp;&nbsp;&nbsp;Date
																						of hire (DOH)</span>&nbsp;&nbsp;&nbsp;&nbsp;
																				</div>
																				<div class="">
																					<input type="radio"
																				...
																				<div class="">
																					<input type="radio"
																						...
																						if (isset ( $model_plan_coverage_type->plan_type_doh ) && $model_plan_coverage_type->plan_type_doh == 5) {
																							?>
																						checked <?php } ?> value="5"><span
																						class="control-checkbox">&nbsp;&nbsp;&nbsp;&nbsp;1st
								...
								<div id="collapseTwo"
									...
									<?php $form = ActiveForm::begin(['action' => ['/client/planclass/coveragetypeoffered?c_id='.$company_id.'&plan_id='.$plan_id],'enableClientValidation' => false,'options' => ['method' => 'post','enctype'=>'multipart/form-data','validateOnSubmit' => true,'class'=>'','id'=>'coverage-type-offerred']]); ?>
										...
										<div class="col-md-offset-1 col-md-10">
											...
											<div class="form-group row plan-div-margin spousediv" id="spouse_conditional_coverage_div"
												...
												<div class="col-md-4" style="margin-top: 10px;">
													<input type="radio"
														class="spouse-conditional-coverage-radio"
				...
				<?php ActiveForm::end(); ?>
							...
							<div class="panel box ">
								<div class="parent-tabs box-header with-border">
									<span id="step1" class="steps col-xs-2 no-wrap"
										onclick="editbasic2()"> <span class="check "
										style="display: none;"> <i class="fa fa-check"
											aria-hidden="true"></i> <span class="">11</span>
									</span> <span style="display: none;" class="edit">Edit</span>
									</span>

									<h4 class="box-title col-sm-6 col-xs-10" style="">
										<div class="fixed-number col-sm-1 col-xs-2" style="top: 3px;">
													...
													<div class="col-sm-12">
														<span class="control-label">
															<h4>"Pay or Play" rule require employees to offer
																...
																each employee's household income. Employers would rarely
																know this number, so the IRS allows for assumptions to
																be made called "safe harbors"</h4>
															...
															<div>
																...
																<span class="control-checkbox">Assume W2 earnings is
															...
															<div>
																<input name="TblAcaEmpContributions[safe_harbor]"
																	...
																	if ($model_plan_emp_contributions->safe_harbor == 2) {
																		...
																		?>
																	checked <?php  } ?> value="2">&nbsp;&nbsp;&nbsp;&nbsp;
																<span class="control-checkbox">Assume household earnings
																	meets federal poverty line (federal poverty line safe
																	harbor)</span>
															</div>
