...
<div class="box box-warning">
	...
	<div class="col-md-12">
            <h3 class="box-title col-sm-6">Add User - <?php echo Html::encode($company_details->company_name); ?> <small> (<?php echo Html::encode($company_details->company_client_number); ?>) </small></h3>
