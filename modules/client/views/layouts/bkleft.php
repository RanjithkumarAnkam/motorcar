 ...
 <?php 
	...
	if($company_id) {
		...
		<?php if(!in_array ( 'notsigned', $arruserpermission, TRUE )) {?>
			...
			<li id="manage_aca_reporting_forms" class="hide"><a
		...
		<div class="modal-content">
			...
			<div class="form-group col-md-12">
				<div class="col-sm-12 add-mem">
					<label class="add-member-label">Client Agreement must be signed before Medical Plan Data can be accessed. Please have the agreement signed.</label>
				</div>
