...
/**
 * This is the model class for table "tbl_aca_1095".
 *
 * @property integer $id
 ...
 */
class TblAca1095 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['form_id', 'ssn', 'serialise_data1', 'serialise_data2', 'created_by'], 'required'],
            [['form_id', 'ssn', 'created_by', 'updated_by'], 'integer'],
            [['serialise_data1', 'serialise_data2', 'serialise_data3', 'xml_data'], 'string'],
