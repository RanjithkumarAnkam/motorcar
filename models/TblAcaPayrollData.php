...
class TblAcaPayrollData extends \yii\db\ActiveRecord
{
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getTblAcaPayrollInconsistentContribution()
    {
    	return $this->hasMany(TblAcaPayrollInconsistentContribution::className(), ['employee_id' => 'employee_id']);
    }
    ...
    public function payrolldata($company_id)
    {
    	...
    	$sql="SELECT taic.employee_id,taic.*,tapd.* FROM tbl_aca_payroll_data tapd LEFT JOIN tbl_aca_payroll_inconsistent_contribution taic ON tapd.employee_id=taic.employee_id WHERE company_id=:company";
